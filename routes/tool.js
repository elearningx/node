...
router.get("/migrate", (req, res) => {
  ...
  table.table_create_migration((result, status) => {
    if (status == "error") {
      res.json({ result });
    } else {
      res.json({ result });
...
router.post("/migration-insert", (req, res) => {
  ...
  table.table_create(temp, (result, status) => {
...
router.post("/show-table-drop", (req, res) => {
  const temp = req.body;
  table.table_drop(temp, (result, status) => {
    res.json({ result, status });
  });
});

router.get("/show-table-list", (req, res) => {
  table.show_table((result, status) => {
    res.json({ result, status });
  });
});

router.post("/show-table-colums", (req, res) => {
  table.show_columns(req.body, (result, status) => {
    res.json({ result, status });
  });
});
router.get("/show-db-name", (req, res) => {
  table.show_db_name((result, status) => {
    res.json({ result, status });
  });
});
